...
<div class="funcionalidad">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Listado Pacientes</h3>
				</div>
			</div>
			<a href=" {{ route('admin.pacientes.create') }} " class="btn btn-info"> Registrar Paciente</a>
			<a href="" class="btn btn-info" onclick="window.open('{{ asset('plugin/pdf/pacientes.pdf') }}', '_blank', 'fullscreen=yes')" >  Mostrar Informe</a>
			<hr>
			<div class="row">
				<div class="col-lg-12">
								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td>{{ $user->email }}</td>
											<td>
												<a href=" {{ route('admin.pacientes.edit', $user->id) }} " class="glyphicon glyphicon-pencil btn btn-info"></a>
												<a href=" {{ route('admin.pacientes.destroy', $user->id) }} " onclick="return confirm('¿Seguro Desea Eliminarlo?')" class="glyphicon glyphicon-trash btn btn-danger"></a>
											</td>
										</tr>
										@endforeach
									</tbody>
