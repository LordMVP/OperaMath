		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-10 col-md-6">
					...
					{!! Form::open(['route' => 'admin.especialidad.store', 'method' => 'POST', 'files' => true]) !!}

					<div class="form-group">
						{!! Form::label('nombre', 'Especialidad') !!}
						{!! Form::text('nombre', null, ['class' => 'form-control', 'placeholder' => 'Nombre De La Especialidad', 'required']) !!}
					</div>
